...
<div id="executing" class="disable">
    ...
    <header class="title">
        <a href="http://stolitor.xsrv.jp/photoregister.html"><img src="../images/shape02.png" alt=""></a>
        <p>登録リスト画面</p>
        <span>　</span>
    </header>
    <main>
                ...
                <div class="food-right">
                    ...
                    <div>
                        <label for="">消費期限</label><input class="food-ub editable-input" type="date"
                            value="<?php print_r(date("Y-m-d",strtotime("2 day"))) ?>">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <select name="" class="food-genre select-genre editable-input">
                            ...
                            <?php for ($j = 0; $j < count($genre); $j++) { 
                                if($storage[$j]["id"]==3){ ?>
                                <option value="<?php echo $genre[$j]["id"] ?>" selected><?php echo $genre[$j]["name"] ?></option>
                            <?php }else{ ?>
